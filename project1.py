...
if __name__ == '__main__':
	...
	if go_through_with_program:
		...
		with open(filename,'w') as f:
			...
			f.write("-- total number of context swithces: {}".format(fcfs[3]) + "\n")
			f.write("-- total number of preemptions: {}".format(fcfs[4]) + "\n")
			...
			f.write("-- total number of context swithces: {}".format(srt[3]) + "\n")
			f.write("-- total number of preemptions: {}".format(srt[4]) + "\n")
			...
			f.write("-- total number of context swithces: {}".format(rr[3]) + "\n")
			f.write("-- total number of preemptions: {}".format(rr[4]) + "\n")
		# print(rr)
